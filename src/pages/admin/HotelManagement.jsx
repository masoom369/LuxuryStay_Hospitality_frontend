        ...
        <table className="w-full bg-white rounded-lg shadow-md overflow-hidden">
          <thead className="bg-accent text-white">
            <tr>
              ...
              <th className="p-3 text-left font-primary">Location</th>
              <th className="p-3 text-left font-primary">Rating</th>
          ...
          <tbody>
            {hotels.map((hotel) => (
              <tr key={hotel.id} className="border-b">
                <td className="p-3 font-secondary">{hotel.name}</td>
                <td className="p-3 font-secondary">{hotel.location}</td>
                <td className="p-3 font-secondary">{hotel.rating}</td>
                <td className="p-3 text-center flex justify-center gap-2">
                  <button onClick={() => handleEdit(hotel)} className="text-accent hover:underline">
                    <Edit size={16} />
                  </button>
