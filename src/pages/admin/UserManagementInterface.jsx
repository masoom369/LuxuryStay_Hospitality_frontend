          ...
          <div className="row align-items-center">
            <div className="col">
              <div className="mt-5">
                ...
                <button onClick={() => { setEditingUser(null); setIsModalOpen(true); }} className="btn btn-primary float-right veiwbutton">Add User</button>
              </div>
            </div>
          </div>
        </div>
            ...
            <form>
              <div className="row formtype">
                ...
                <div className="col-md-3">
                  <div className="form-group">
                    <label>Search</label>
                    <a href="#" className="btn btn-success btn-block mt-0 search_button"> Search </a>
                  </div>
                </div>
              </div>
            </form>
                    ...
                    <tbody>
                      {users.map((u) => (
                        <tr key={u._id}>
                          <td>{u.name}</td>
                          <td>{u.email}</td>
                          <td>{u.assignments?.map(a => a.role).join(', ') || 'None'}</td>
                          <td>{u.hotel || 'N/A'}</td>
                          <td className="text-right">
                            <div className="dropdown dropdown-action">
                              ...
                              <div className="dropdown-menu dropdown-menu-right">
                                <a className="dropdown-item" onClick={() => { setEditingUser(u); setIsModalOpen(true); }}>
                                  <i className="fas fa-pencil-alt m-r-5"></i> Edit
                                </a>
                                <a className="dropdown-item" onClick={() => handleDeactivateUser(u._id)} data-toggle="modal" data-target="#delete_user">
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              <div className="modal-body text-center">
                ...
                <h3 className="delete_class">Are you sure want to delete this User?</h3>
