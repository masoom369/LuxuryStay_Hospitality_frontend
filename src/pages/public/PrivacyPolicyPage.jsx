    ...
    <section>
      ...
      >
        ...
        <div className="text-center z-20">
          <h1 className="text-6xl text-white font-primary">Privacy Policy</h1>
        ...
        <div className="bg-white shadow-lg rounded-lg overflow-hidden p-8">
          ...
          <div className="max-w-4xl mx-auto">
            <PolicySection title="Our Commitment">
              <p>
                At LuxuryStay Hospitality, we take the privacy and security of
                our guests seriously. This policy outlines our practices for
                handling personal information across all our properties and
                digital platforms.
              </p>
            </PolicySection>
            ...
            <PolicySection title="Data Protection">
              <p>
                ...
                security measures. We never share personal information with
                unauthorized third parties and maintain strict access controls
