  ...
  const services = [
    {
      name: "Spa & Wellness",
      description:
        "Indulge in our world-class spa treatments, massages, and wellness therapies designed to rejuvenate your body and mind.",
      price: 150,
    ...
    },
    {
      name: "Fine Dining",
      description:
        "Experience culinary excellence with our award-winning restaurants featuring local and international cuisine.",
      price: 85,
    ...
    },
    {
      ...
      description:
        "Let our expert concierge team arrange transportation, tours, tickets, and personalized experiences for you.",
      price: null,
    ...
    },
    {
      name: "Fitness Center",
      description:
        "Stay active with our fully equipped fitness center, personal training sessions, and group classes.",
      price: 25,
    ...
    },
    {
      ...
      description:
        "Access our business center with high-speed internet, meeting rooms, and office equipment.",
      price: 15,
    ...
    },
    {
      name: "Event Planning",
      description:
        "Host your special events with our professional event planning services and elegant venues.",
      price: null,
        ...
        <div className="container mx-auto py-14 px-4">
          <div className="mx-auto max-w-5xl text-center">
            ...
            <p className="text-lg text-gray-700 mb-6 text-justify">
              ...
              stay unforgettable. From wellness treatments to dining
              experiences, we cater to every need and desire.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div>
              ...
              <p className="text-white/90 text-sm mt-1">
                Contact our concierge for custom arrangements and exclusive
                experiences.
              </p>
            </div>
